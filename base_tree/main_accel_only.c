...
int main(void)
{
  ...
  uint8_t msg[64];
  int init_len = snprintf((char *)msg, sizeof(msg), "Accel OK\r\n");
  HAL_UART_Transmit(&huart3, msg, init_len, HAL_MAX_DELAY);
