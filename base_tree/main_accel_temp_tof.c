/**
  ******************************************************************************
  * @file    main.c
  * @brief   Verified: Accel + Temp + ToF on dual UART @ 115200 baud
  *          Saved: 2026-04-27 — all sensors working
  ******************************************************************************
  */
...
int main(void)
{
  ...
  /* ToF sensor init FIRST (I2C2) — must be before accel/temp on I2C1 */
